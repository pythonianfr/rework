...
<X> host(<X>.<X>.<X>.<X>) `unstopable_death` path(.../tests/tasks.py)
<X> host(<X>.<X>.<X>.<X>) `normal_exception` path(.../tests/tasks.py)
<X> host(<X>.<X>.<X>.<X>) `allocate_and_leak_mbytes` path(.../tests/tasks.py)
<X> host(<X>.<X>.<X>.<X>) `capture_logs` path(.../tests/tasks.py)
<X> host(<X>.<X>.<X>.<X>) `log_swarm` path(.../tests/tasks.py)
<X> host(<X>.<X>.<X>.<X>) `stderr_swarm` path(.../tests/tasks.py)
<X> host(<X>.<X>.<X>.<X>) `flush_captured_stdout` path(.../tests/tasks.py)
